...
TODO: update fixtures and assertions to match Credit Risk Default data schema.
"""
...
def sample_df():
    """
    Minimal synthetic DataFrame that mirrors the schema of Credit risk data - TBD.

    TODO: update columns to match the actual dataset for Credit Risk Default.
    Keep this small (50 to 100 rows) — it runs in CI without real data files.
    """
    n = 100
    return pd.DataFrame({
        # TODO: add columns matching Credit risk data - TBD schema
        "id": range(n),
...
def test_encode_adds_expected_columns(sample_df):
    ...
    # TODO: update expected encoded column names for Credit Risk Default
